	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 ...
		 //check if the list is empty
			...
			for(int n=0;n<list.size();n++){
				...
				String Discription=read_Data.getIntructions();
		
				out.println("<tr>");
				
				out.println("<td>");
				out.println("<h3>Order Number</h3>");
		    ...
		    out.println("<form action=\"Cancel_Order.jsp\">");
		    out.println("");
		    out.println("Item No");
		    
		    out.println("<input type=\"text\" name=\"item_No\" required pattern=\"[0-9]+\">");
		    
		    out.println("<input type=\"submit\" value=\"Cancel\" name=\"action\"><br>");
